...
As it turns out, there is a significant positive correlation between the average ratings across locations and the overall ratings, *r* `r rValue(correlation$estimate)`, *p* `r pValue(correlation$p.value)`. 